...
const replies_1 = require("../models/replies");
exports.collections = [];
async function connectToDatabase() {
    ...
    const checkSchema = [
        ...
        { coll: process.env.COLLECTION_NAME_C, schema: comments_1.commentSchema },
        { coll: process.env.COLLECTION_NAME_R, schema: replies_1.repliSchema },
    ];
    ...
    const commentCollection = db.collection(process.env.COLLECTION_NAME_C);
    const repliCollection = db.collection(process.env.COLLECTION_NAME_R);
    ...
    exports.collections[2] = commentCollection;
    exports.collections[3] = repliCollection;
